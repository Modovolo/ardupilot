        ...
        for (uint8_t i = 2; i < argc; i++) {
            ...
            if (strcmp(cmd,"yaw_headroom") == 0) {
                ...
                switch (frame_class) {
                    ...
                    case AP_Motors::MOTOR_FRAME_CUSTOME18_UB_DARPA:
                    case AP_Motors::MOTOR_FRAME_CUSTOME18_BALANCED_ADJ:
...
void print_all_motors()
{
    ...
    for (uint8_t frame_class=0; frame_class <= AP_Motors::MOTOR_FRAME_CUSTOME18_BALANCED_ADJ; frame_class++) {
