...
bool AP_MotorsMatrix::setup_custom24_ub_darpa_matrix(motor_frame_type frame_type)
{
    (void)frame_type;
    _mav_type = MAV_TYPE_GENERIC;
    _frame_class_string = "CUSTOM24_UB_DARPA";
    ...
    static const AP_MotorsMatrix::MotorDefRaw motors[] {
        { -0.193f, -0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  1 },
        {  0.193f,  0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   2 },
        { -0.385f,  0.0f,   AP_MOTORS_MATRIX_YAW_FACTOR_CW,   3 },
        {  0.385f,  0.0f,   AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  4 },
        {  0.193f, -0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   5 },
        { -0.193f,  0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  6 },
        { -0.385f, -0.667f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   7 },
        {  0.385f,  0.667f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  8 },
        {  0.577f, -0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   9 },
        { -0.578f,  0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 10 },
        {  0.0f,    0.667f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  11 },
        {  0.0f,   -0.667f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 12 },
        { -0.578f, -0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  13 },
        {  0.578f,  0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 14 },
        {  0.77f,   0.0f,   AP_MOTORS_MATRIX_YAW_FACTOR_CW,  15 },
        { -0.385f,  0.667f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  16 },
        { -0.77f,   0.0f,   AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 17 },
        {  0.385f, -0.667f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 18 },
        { -0.192f,  1.0f,   AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 19 },
        {  0.77f,  -0.667f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  20 },
        { -0.962f, -0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  21 },
        {  0.962f, -0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 22 },
        { -0.77f,  -0.667f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 23 },
        {  0.193f,  1.0f,   AP_MOTORS_MATRIX_YAW_FACTOR_CW,  24 },
    };
    add_motors_raw(motors, ARRAY_SIZE(motors));
    return true;
#endif
...
void AP_MotorsMatrix::setup_motors(motor_frame_class frame_class, motor_frame_type frame_type)
{
    ...
    case MOTOR_FRAME_DECA:
        ...
        break;
#endif //AP_MOTORS_FRAME_DECA_ENABLED
    case MOTOR_FRAME_CUSTOM24_UB_DARPA:
        success = setup_custom24_ub_darpa_matrix(frame_type);
        break;
    default:
